...
export default function Quiz() {
  ...
  if (!current) return <div className="flex flex-col items-center justify-center h-screen gap-4">
            ...
            <p className={`text-gray-400 text-2xl ${orbitron.className}`}>Loading your quiz</p>
          </div>
